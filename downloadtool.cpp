...
DownloadTool::DownloadTool(const QString& downloadUrl, const QString& savePath, const QString& filename, QObject* parent)
    : QObject(parent)
{
...
void DownloadTool::startDownload()
{
    ...
    qDebug() << QString("m_downloadUrl: %1\n newUrl: %2").arg(m_downloadUrl, newUrl.errorString());
    ...
    qDebug() << QString("newUrl.fileName: %1 newUrl.userName: %2 newUrl.userInfo:%3").arg(m_filename, newUrl.userName(), newUrl.userInfo());
